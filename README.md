...
- The **Translator** class enables easy, human in the loop transitioning of Collection Protocol Workflows between environments, and a generic Diff Report function to compare Workflows. This class is no longer necessary as of v8, so long as you've never used an earlier version of OpS (or have since started fresh with v8) and forms/fields are named consistenly across environments
